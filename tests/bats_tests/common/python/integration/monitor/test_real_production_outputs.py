...
class TestRealTRESParsing:
    ...
    def test_parse_real_tres_with_energy(self, real_sstat_parseable_output):
        ...
        # Parse a TRES string
        tres_str = "cpu=01:15:23,energy=89564,fs/disk=49430961202,mem=142462354K,pages=101,vmem=542192528K"
...
class TestRealProductionEdgeCases:
    ...
    def test_tres_zero_cpu_time(self, real_sstat_parseable_output):
        ...
        assert (
            "cpu=01:15:23" in real_sstat_parseable_output
            or "cpu=00:00:00" in real_sstat_parseable_output
        )
