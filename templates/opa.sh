...
MEMBER=${43:-%MEMBER%}
REQUEST_REALIZATION=${44:-%REQUEST.REALIZATION%}
CHUNK_START_MONTH=${45:-%CHUNK_START_MONTH%}
SPLIT_SECOND_TO_LAST_DATE=${46:-%SPLIT_SECOND_TO_LAST_DATE%}
ENERGY_INDICATORS_MASK_FILE_5=${47:-%ENERGY_INDICATORS.MASK_FILE_5%}
ENERGY_INDICATORS_MASK_FILE_10=${48:-%ENERGY_INDICATORS.MASK_FILE_10%}
ENERGY_INDICATORS_MASK_FILE_25=${49:-%ENERGY_INDICATORS.MASK_FILE_25%}
ENERGY_INDICATORS_GRID=${50:-%ENERGY_INDICATORS.GRID%}
...
ENERGYTDIG_IN_DATA_VERSION=${ENERGY_INDICATORS_IN_DATA_VERSION}
