...
from AMSUA import AMSUA  # noqa: F401
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataPath", type=str, default="", help="Path to the data repository"
    )
    parser.add_argument(
        "--expName",
        type=str,
    ...
    if data.dataType == "SYNOP":
        ...
        # --------------------------
        # See:
        # https://earth.bsc.es/gitlab/digital-twins/de_340-2/workflow/-/issues/1051#note_398070
        pass
