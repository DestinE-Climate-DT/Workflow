...
NODES=${22:-%HPCNODES%}
TASKS=${23:-%HPCTASKS%}
IFS_IO_PPN=${24:-%HPCIFS_IO_PPN%}
NEMO_IO_PPN=${25:-%HPCNEMO_IO_PPN%}
IFS_IO_NODES=${26:-%HPCIFS_IO_NODES%}
NEMO_IO_NODES=${27:-%HPCNEMO_IO_NODES%}
IFS_IO_TASKS=${28:-%HPCIFS_IO_TASKS%}
NEMO_IO_TASKS=${29:-%HPCNEMO_IO_TASKS%}
