...
# =======================================================================================================================
#
#   DESCRIPTION:    Introduces perturbations to the surface level of the 3D
#                   temperature field ('tn') of a NEMO restart file.
#                   The perturbed restart is stored into a copy of the original
#                   file.
#
...
#          BUGS:    ---
#         NOTES:    ---
#        AUTHOR:    Kai Keller (kai.keller@bsc.es) and Nuno Rocha (nuno.rocha@bsc.es)
#       COMPANY:
#       VERSION:    0.2
#       CREATED:    11/01/24 13:12:27 EET
#      REVISION:    26/04/24 15:46:00 EET, by Nuno Rocha.
# =======================================================================================================================
...
parser.add_argument(
    ...
    action="store",
    metavar="NUMBER",
    help="static seed for the random engine",
)
parser.add_argument(
    "-p",
    "--perturbation",
    action="store",
    metavar="FLOAT",
    help="perturbation (sigma for normal-distribution) [default = 0.0002 K]",
)
...
if args.perturbation is not None:
    if not is_float(args.perturbation):
        sys.exit(
            f"(error) perturbation -> {args.perturbation} is not a valid integer number"
        )
