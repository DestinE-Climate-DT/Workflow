...
# cf histo
# Define arguments:
# Define processes, each with a different cf_type

print(f"mask file: {mask_file}")

process1 = multiprocessing.Process(
    target=run_capacity_factor_histogram_opa,
    args=(iniyear, inimonth, iniday, finyear, finmonth, finday, out_path, out_path),
    kwargs={"cf_type": "I", "mask": mask_file},
)

process2 = multiprocessing.Process(
    target=run_capacity_factor_histogram_opa,
    args=(iniyear, inimonth, iniday, finyear, finmonth, finday, out_path, out_path),
    kwargs={"cf_type": "II", "mask": mask_file},
)

process3 = multiprocessing.Process(
    target=run_capacity_factor_histogram_opa,
    args=(iniyear, inimonth, iniday, finyear, finmonth, finday, out_path, out_path),
    kwargs={"cf_type": "III", "mask": mask_file},
)

process4 = multiprocessing.Process(
    target=run_capacity_factor_histogram_opa,
    args=(iniyear, inimonth, iniday, finyear, finmonth, finday, out_path, out_path),
    kwargs={"cf_type": "S", "mask": mask_file},
)
