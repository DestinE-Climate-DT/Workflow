...
-->
## 6.2.7 (Released Sep 2027)

### Added

- Add windspeed and soil ouput defintions for 4xCO2 ICON run

### Changed

- Allow default and fc0 member defintions for ICON  

### Fixed

- Fixed bug which made CLEAN job compress failed jobs logs and rundirs recursively for ICON
- Fixed bug which missed some rundir cases during the CLEAN job tarring
