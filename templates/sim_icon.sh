...
HDF5_USE_FILE_LOCKING=${27:-%CURRENT_HDF5_USE_FILE_LOCKING%}
FI_CXI_OPTIMIZED_MRS=${28:-%CURRENT_FI_CXI_OPTIMIZED_MRS%}
FI_CXI_RX_MATCH_MODE=${29:-%CURRENT_FI_CXI_RX_MATCH_MODE%}
FI_MR_CACHE_MONITOR=${30:-%CURRENT_FI_MR_CACHE_MONITOR%}
MPICH_ALLREDUCE_NO_SMP=${31:-%CURRENT_MPICH_ALLREDUCE_NO_SMP%}
MPICH_COLL_OPT_OFF=${32:-%CURRENT_MPICH_COLL_OPT_OFF%}
PMI_SIGNAL_STARTUP_COMPLETION=${33:-%CURRENT_PMI_SIGNAL_STARTUP_COMPLETION%}
MPICH_SMP_SINGLE_COPY_MODE=${34:-%CURRENT_MPICH_SMP_SINGLE_COPY_MODE%}
# END_HEADER
