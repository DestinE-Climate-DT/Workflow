...
NODES=${19:-%HPCNODES%}
TASKS=${20:-%HPCTASKS%}
IFS_IO_PPN=${21:-%HPCIFS_IO_PPN%}
NEMO_IO_PPN=${22:-%HPCNEMO_IO_PPN%}
IFS_IO_NODES=${23:-%HPCIFS_IO_NODES%}
NEMO_IO_NODES=${24:-%HPCNEMO_IO_NODES%}
IFS_IO_TASKS=${25:-%HPCIFS_IO_TASKS%}
NEMO_IO_TASKS=${26:-%HPCNEMO_IO_TASKS%}
