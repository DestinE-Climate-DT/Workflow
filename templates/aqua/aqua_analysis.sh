...
HPC_PROJECT_ROOT=${16:-%CURRENT_HPC_PROJECT_ROOT%}
SCRATCH_DIR=${17:-%CURRENT_SCRATCH_DIR%}
LOCAL_DIR=${18:-%CURRENT_LOCAL_DIR%}
MEMBER=${19:-%MEMBER%}
MEMBER_LIST=${20:-%EXPERIMENT.MEMBERS%}
AQUA_CONFIG=${21:-%AQUA.INSTALL_DIR%}
CARTOPY_DATA_DIR=${22:-%AQUA.CARTOPY_DATA_DIR%}
...
singularity exec \
    ...
    bash -c \
    "
    aqua analysis --loglevel debug --model $MODEL --exp $EXPVER --source $SOURCE --outputdir $OUTPATH --catalog $CATALOG --realization r$REALIZATION --parallel
    "
