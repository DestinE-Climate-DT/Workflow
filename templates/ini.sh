...
CONTAINER_DIR=${33:-%CURRENT_CONTAINER_DIR%}
HPC_PROJECT_ROOT=${34:-%CURRENT_HPC_PROJECT_ROOT%}
SCRATCH_DIR=${35:-%CURRENT_SCRATCH_DIR%}
LOCAL_DIR=${36:-%CURRENT_LOCAL_DIR%}
START_DATE=${37:-%SDATE%}
RESTART_FROM=${38:-%RUN.RESTART_FROM%}
RESTARTS_FROM_PATH=${39:-%MODEL.RESTARTS_FROM_PATH%}
RESTARTED_RUN=${40:-%RUN.RESTARTED_RUN%}
PRE_RESTART_DIR=${41:-%CONFIGURATION.PRE_RESTART_DIR%}
