...
HYDROLAND_APPLY_CDO_MERGETIME=${70:-%HYDROLAND.APPLY_CDO_MERGETIME%}
OBSALL_VERSION=${71:-%OBSALL.VERSION%}
REQUEST_REALIZATION=${72:-%REQUEST.REALIZATION%}
HYDROMET_RUN_FREQUENCY=${73:-%HYDROMET.RUN_FREQUENCY%}
ENERGY_INDICATORS_MASK_FILE_5=${74:-%ENERGY_INDICATORS.MASK_FILE_5%}
ENERGY_INDICATORS_MASK_FILE_10=${75:-%ENERGY_INDICATORS.MASK_FILE_10%}
ENERGY_INDICATORS_MASK_FILE_25=${76:-%ENERGY_INDICATORS.MASK_FILE_25%}
ENERGY_INDICATORS_GRID=${77:-%ENERGY_INDICATORS.GRID%}
ENERGY_OFFSHORE_COMPUTE_ICING=${78:-%ENERGY_OFFSHORE.COMPUTE_ICING%}
OBSALL_IN_DATA_VERSION=${79:-%OBSALL.IN_DATA_VERSION%}
OPA_MP_PROC=${80:-%CURRENT_OPA_MP_PROC%}
DATA_PORTFOLIO=${81:-%CONFIGURATION.DATA_PORTFOLIO%}
