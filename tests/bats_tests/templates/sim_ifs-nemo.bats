...
setup() {
    ...
    export MULTIO_ATM_PLANS="full"
    export MULTIO_OCEAN_PLANS="full"
    export PU="cpu"
    ...
    export OPERATIONAL_PROJECT_SCRATCH="${ROOTDIR}/proj/${PROJDEST}/scratch"
    export DEVELOPMENT_PROJECT_SCRATCH="${ROOTDIR}/proj/${PROJDEST}/scratch"
    export HPC_PROJECT_ROOT=${ROOTDIR}
    export LOCAL_DIR="${ROOTDIR}/appl/local"
    export SIM_START_DATE=${START_DATE}
    export IFS_EXPVER="test"
    export LABEL="hz9m"
    export GTYPE="gtype"
    export RESOL="tco123"
    export LEVELS="137"
