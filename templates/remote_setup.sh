...
SCRATCH_DIR=${39:-%CURRENT_SCRATCH_DIR%}
...
LOAD_FDB=${66:-%CONFIGURATION.LOAD_FDB%}
CREATE_FDB_INFO_FILE=${67:-%CONFIGURATION.CREATE_FDB_INFO_FILE%}
INPROOT_CHECKER=${68:-%CONFIGURATION.INPROOT_CHECKER%}
START_DATE=${69:-%SDATE%}

LOAD_FDB=${70:-%CONFIGURATION.LOAD_FDB%}
CREATE_FDB_INFO_FILE=${71:-%CONFIGURATION.CREATE_FDB_INFO_FILE%}
INPROOT_CHECKER=${72:-%CONFIGURATION.INPROOT_CHECKER%}
USER=${73:-%CURRENT_USER%}

BUNDLE_BUILD_DIR=${74:-%MODEL.BUNDLE_BUILD_DIR%}
BUNDLE_SOURCE_DIR=${75:-%MODEL.BUNDLE_SOURCE_DIR%}
