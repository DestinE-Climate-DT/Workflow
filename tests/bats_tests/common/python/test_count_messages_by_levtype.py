...
def test_count_messages_in_file_clte():
    ...
    assert (
        count_messages_in_file(str(test_file), args) == 25296
    )  # 34 vars * 744 timesteps
...
def test_get_levtype():
    profiles = [
        ...
        "pl_6-hourly_healpix_standard.yaml",
        "o3d_2_daiy_healpix_high.yaml",
...
def group_by_levtype_full():
    profiles = [
        ...
        "hl_hourly_healpix_high.yamlhl_hourly_healpix_standard.yaml",
        "hl_monthly_healpix_standard.yaml",
    ...
    assert set(profiles_by_levtype.keys()) == set(
