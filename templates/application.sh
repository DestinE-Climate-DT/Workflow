...
HYDROLAND_STAT_FREQ=${57:-%HYDROLAND.1.OPAREQUEST.stat_freq%}
HYDROLAND_GRID=${58:-%HYDROLAND.GRID%}
HYDROLAND_TEMP=${59:-%HYDROLAND.1.OPAREQUEST.variable%}
HYDROLAND_PRE=${60:-%HYDROLAND.2.OPAREQUEST.variable%}
