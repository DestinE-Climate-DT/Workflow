...
- Improved the operational configuration and created specific configuraiton files for e-suite and o-suite.
...
- Spatial mask applied to OPA. Adaptation of the applcation template for energy indicators to use the same mask.
...
- Standarized IFS-NEMO model and simulation configurations.
