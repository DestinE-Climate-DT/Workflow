...
###############################################################################
# Script to update AQUA to a new version
#
# Usage: ./update_aqua.sh --version <version> --platform <platform> --model_version <model_version> --branch <branch>
#
...
output=$({ autosubmit testcase \
    --description "Update AQUA to ${version}" \
    --HPC ${platform} \
