...
def main():
    parser = argparse.ArgumentParser(
        description="Replace field in IFS initial conditions."
    )
    ...
    if args.seed is not None:
        print(
            "Initializing random number generator with seed " + str(args.seed) + " ..."
        )
    ...
    while True:
        ...
        if (
            args.shortname
            and args.shortname == grib_get(gid, "shortName")
            or not args.shortname
        ):
