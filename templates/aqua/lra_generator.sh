...
CHUNK_SECOND_TO_LAST_YEAR=${27:-%CHUNK_SECOND_TO_LAST_YEAR%}
CHUNK_SECOND_TO_LAST_MONTH=${28:-%CHUNK_SECOND_TO_LAST_MONTH%}
CHUNK_SECOND_TO_LAST_DAY=${29:-%CHUNK_SECOND_TO_LAST_DAY%}
