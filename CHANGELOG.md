...
-->
## v5.0.16 (Released March 2026)

- Add support for high-node yaco improvements
- Support newer cce20 changes in ICON, YACO

## v5.0.15 (Released November 2025)

- Added runscripts for 4xCO2 ICON experiment
- Added ICON projection 2015-2050 conf

## v5.0.14 (Released November 2025)

- Support restarts in IFS-NEMO for handovered runs by making the restarts paths configurable.
- Fixed dates definition of WIPE.

## v5.0.13 (Released September 2025)

- Data porfolio updated to v1.2.3

## v5.0.12 (Released September 2025)

### Changed

- IFS-FESOM configuration for historical and projection tco2559

## v5.0.11 (Released July 2025)

### Added

- Bindings missing for operational project in TRANSFER, CLEAN and WIPE.
- Added volcanic aersol forcings for ICON
- Added ICON R2B8 hist testcase option
- Parametrized ICON env variables

### Changed

- Removed the `*_used`auxiliary files in the opa template.
- Updated Energy Offshore to v0.4.8
- Default experiment name for AQUA is the EXPID (was the EXPVER) and can be tuned with AQUA.EXPERIMENT_NAME.

## v5.0.10 (Released May 2025)

### :sparkles: Highlights

This operational release updates the inter-chunk dependencies between OPA and APPs, fixes data glitches in ICON, updates AQUA and OPA versions and incorporates minor improvements in Energy Onshore.

### Changed

- Fix for ICON "tcc" and "wind stress" data glitches.
- Dependencies interchunk in OPAs and APPs.
- Remove legacy data request in energy onshore
- Extend default energy onshore region to +10E longitude.
- Fixed TOTALJOBS of AQUA to 1
- Updated AQUA to v0.13.7
- Updated OPA to v0.7.4

## v5.0.9 (Released May 2025)

### :sparkles: Highlights

This operational release updates IFS-NEMO to DE_CY48R1.0_climateDT_20250521 and DVC to 2025.0.2.

## v5.0.8 (Released May 2025)

### :sparkles: Highlights

This operational release fixes the following issues:

- LUMI-specific:
  - Binds additional directories for the `fix_constant_variables` correct execution.
  - Binds additional directories in the CLEAN task.
- Restarted runs:
  - `fix_constant_variables` based on a flag rather than only run in the first chunk.

## v5.0.7 (Released May 2025)

### Changed

- Updated GSV container to gsv-v2.9.7_base-v5 to solve the DQC issues in the production environment.

## v5.0.6 (Released Apr 30 17:00 2025 +0200)

### :sparkles: Highlights

This operational release fixes Hydroland restarts and adapts the DQC wallclock to model resolution.
...
- Accept `RUN.TYPE: operational` in the checker of the run types.
- Fix AQUA startdate in remote setup template.
