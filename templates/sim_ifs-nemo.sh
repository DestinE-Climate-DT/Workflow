...
RAPS_BIN=${70:-%MODEL.RAPS_BIN%}
BUNDLE_BUILD_DIR=${71:-%MODEL.BUNDLE_BUILD_DIR%}
PRE_RESTART_DIR=${72:-%CONFIGURATION.PRE_RESTART_DIR%}
RESTART_DIR=${73:-%CONFIGURATION.RESTART_DIR%}
WEIGHTS_DIR=${74:-%MODEL.WEIGHTS_DIR%}

VARS_TO_EXPORT=${75:-%CONFIGURATION.VARS_TO_EXPORT%}
AS_JOBNAME=${76:-%JOBNAME%}
...
RESOLUTION=${77:-%MODEL.RESOLUTION%}
CHUNK_SECOND_TO_LAST_DATE=${78:-%CHUNK_SECOND_TO_LAST_DATE%}
FDB_HOME=${79:-%REQUEST.FDB_HOME%}
CLASS=${80:-%REQUEST.CLASS%}
DATASET=${81:-%REQUEST.DATASET%}
ACTIVITY=${82:-%REQUEST.ACTIVITY%}
EXPERIMENT=${83:-%REQUEST.EXPERIMENT%}
GENERATION=${84:-%REQUEST.GENERATION%}
MODEL_REQ=${85:-%REQUEST.MODEL%}
STREAM=${86:-%REQUEST.STREAM%}
COMPLEXITY_IFS=${87:-%PERFORMANCE_METRICS.COMPLEXITY.IFS%}
COMPLEXITY_NEMO=${88:-%PERFORMANCE_METRICS.COMPLEXITY.NEMO%}
PERFORMANCE_METRICS_VERSION=${89:-%PERFORMANCE_METRICS.VERSION%}
PERFORMANCE_RESOLUTION=${90:-%PERFORMANCE_METRICS.RESOLUTION%}
# END_HEADER
