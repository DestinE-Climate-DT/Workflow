...
@test "load_template" {
    run source "${ROOTDIR}/proj/${PROJDEST}/templates/aqua/lra_generator.sh" ${ROOTDIR} ${PROJDEST} ${EXPID} ${HPC_PROJECT} ${CONTAINER_VERSION} ${MODEL} ${EXPVER} ${CATALOG_NAME} ${CHUNK_END_DATE} ${SDATE} ${CURRENT_ARCH} ${JOBNAME} ${HPC_SCRATCH}
    assert_success
}
