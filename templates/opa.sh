...
ENERGY_INDICATORS_IN_DATA_VERSION=${32:-%ENERGY_INDICATORS.IN_DATA_VERSION%}
ENERGY_OFFSHORE_IN_DATA_VERSION=${33:-%ENERGY_OFFSHORE.IN_DATA_VERSION%}
HYDROMET_IN_DATA_VERSION=${34:-%HYDROMET.IN_DATA_VERSION%}
HYDROLAND_IN_DATA_VERSION=${35:-%HYDROLAND.IN_DATA_VERSION%}
WILDFIRES_WISE_IN_DATA_VERSION=${36:-%WILDFIRES_WISE.IN_DATA_VERSION%}
WILDFIRES_FWI_IN_DATA_VERSION=${37:-%WILDFIRES_FWI.IN_DATA_VERSION%}
OBSALL_IN_DATA_VERSION=${38:-%OBSALL.IN_DATA_VERSION%}
DATA_IN_DATA_VERSION=${39:-%DATA.IN_DATA_VERSION%}
APP_AUX_IN_DATA_DIR=${40:-%APP_AUX_IN_DATA_DIR%}
...
HPC_PROJECT_ROOT=${43:-%CURRENT_HPC_PROJECT_ROOT%}
LOCAL_DIR=${44:-%CURRENT_LOCAL_DIR%}
MEMBER=${45:-%MEMBER%}
REQUEST_REALIZATION=${46:-%REQUEST.REALIZATION%}
CHUNK_START_MONTH=${47:-%CHUNK_START_MONTH%}
SPLIT_SECOND_TO_LAST_DATE=${48:-%SPLIT_SECOND_TO_LAST_DATE%}
ENERGY_INDICATORS_MASK_FILE_5=${49:-%ENERGY_INDICATORS.MASK_FILE_5%}
ENERGY_INDICATORS_MASK_FILE_10=${50:-%ENERGY_INDICATORS.MASK_FILE_10%}
ENERGY_INDICATORS_MASK_FILE_25=${51:-%ENERGY_INDICATORS.MASK_FILE_25%}
ENERGY_INDICATORS_GRID=${52:-%ENERGY_INDICATORS.GRID%}
