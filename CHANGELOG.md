...
## 5.1.7 (Released November 2025)

#### :sparkles: Highlights

Release used in production that introduces Dataportfolio v1.2.3 (for ICON transfers).
Inlcudes new ci/cd runner configuration to correctly run pipelines.
