...
RESTARTED_RUN=${16:-%RUN.RESTARTED_RUN%}

# Load ICON grid identifiers
ATM_GID=${17:-%CONFIGURATION.ICON.ATM_GID%}
OCE_GID=${18:-%CONFIGURATION.ICON.OCE_GID%}

# Load ICON grid res
ATM_GRID_REF=${19:-%CONFIGURATION.ICON.ATM_REF%}
OCE_GRID_REF=${20:-%CONFIGURATION.ICON.OCE_REF%}
...
if [[ "${INPROOT_CHECKER,,}" == "true" && "${RESTARTED_RUN,,}" != "true" ]]; then
