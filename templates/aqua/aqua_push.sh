...
APP_OUTPATH=${7:-%APP.OUTPATH%}
HPCARCH=${8:-%DEFAULT.HPCARCH%}
CATALOG=${9:-%HPCCATALOG_NAME%}
BUCKET=${10:-%AQUA.BUCKET%}
REPOSITORY=${11:-%AQUA.REPOSITORY%}
EXPERIMENT_NAME=${12:-%AQUA.EXPERIMENT_NAME%}
...
exps=${CATALOG}/${MODEL}/${EXPERIMENT_NAME}
